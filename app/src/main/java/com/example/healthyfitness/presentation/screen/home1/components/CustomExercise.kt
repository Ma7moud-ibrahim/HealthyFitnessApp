package com.example.healthyfitness.presentation.screen.home1.components
...
@Composable
fun ItemCard(modifier: Modifier, imageId: Int, bodyText: String, hours: Int, minutes: Int,onItemClicked:()->Unit) {
    Card(
